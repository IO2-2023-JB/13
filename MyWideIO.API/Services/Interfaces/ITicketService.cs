...
namespace MyWideIO.API.Services.Interfaces
{
    public interface ITicketService
    {
        ...
        public Task<GetTicketDto> GetTicketAsync(Guid ticketId, CancellationToken cancellationToken = default);
        public Task<GetTicketStatusDto> GetTicketStatusAsync(Guid ticketId, CancellationToken cancellationToken = default);
