          ...
          <ul style={{padding:"0px", display:"inline"}}>
              {usersData.map(user => (
                  <li className="search_list_item" class="mx-5" style={{marginTop:"20px", color:"white", borderRadius:"15px",
                      ...
                      <div class="row">
                        <div className="box3" style={{width:"300px", height:"170px", cursor: "pointer"}}>
                          <div className="box4" style={{width:"280px", height:"150px", backgroundImage: `url(${user.avatarImage})`, backgroundRepeat:"no-repeat", backgroundSize:"cover", backgroundPosition:"center"}}>
                              <table style={{backgroundColor: "transparent"}}>
                                  <tr style={{backgroundColor: "transparent"}}>
